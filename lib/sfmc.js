...
// Prefix applied to the asset customerKey ("template key")
const ASSET_KEY_PREFIX = 'LPB_';

let cachedToken = null;
let cachedCategoryId = null;

/**
 * Build the template key for a given project.
 */
function customerKeyFor(projectName) {
    return `${ASSET_KEY_PREFIX}${projectName}`;
}

/**
 * Build the asset display name shown in Content Builder. Same `LPB_`
 */
